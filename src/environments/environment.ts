...
export const auth0Config: IonicAuthOptions = {
  ...
  clientID: 'jtOKp2AI0yjihHzwdGuUzHkT9E9sPkl3',
  discoveryUrl:
    'https://dev-owzab6j6.us.auth0.com/.well-known/openid-configuration',
  logoutUrl: '',
...
export const mobileConfigExtras = {
  redirectUri: 'https://domaintest.dallastjames.dev/login',
  logoutUrl: 'https://domaintest.dallastjames.dev/login',
